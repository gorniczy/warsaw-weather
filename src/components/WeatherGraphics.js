...
export const WeatherGraphics = (props) => {
    return (
      <div>
        {props.graphics === "01" && (
          <img
            src={props.dayTime ? clear_sky_img1 : clear_sky_img2}
        ...
        {props.graphics === "02" && (
          <img
            src={props.dayTime ? few_clouds_img1 : few_clouds_img2}
        ...
        {props.graphics === "10" && (
          <img
            src={props.dayTime ? rain_img1 : rain_img2}
        ...
        {props.graphics === "50" && (
          <img
            src={props.dayTime ? mist_img1 : mist_img2}
